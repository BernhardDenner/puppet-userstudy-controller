...
""",
    ...
    mgr.add_group("g1", [
        'q0',
        'task1a', 'task1b', 'q1',
        'task2.1a', 'task2.1b', 'task2.1c', 'task2.1d', 'q2.1',
        'task2.2a', 'task2.2c', 'task2.2d', 'q2.2',
        'task3.1a', 'task3.1b', 'q3.1',
        'task3.2a', 'task3.2b', 'q3.2'
        ])

    mgr.add_group("g2", [
        'q0',
        'task1b', 'task1a', 'q1',
        'task2.1d', 'task2.1a', 'task2.1b', 'task2.1c', 'q2.1',
        'task2.2d', 'task2.2a', 'task2.2c', 'q2.2',
        'task3.1b', 'task3.1a', 'q3.1',
        'task3.2b', 'task3.2a', 'q3.2'
        ])
    mgr.add_group("g3", [
        'q0',
        'task1a', 'task1b', 'q1',
        'task2.1c', 'task2.1a', 'task2.1b', 'task2.1d', 'q2.1',
        'task2.2c', 'task2.2a', 'task2.2d', 'q2.2',
        'task3.1a', 'task3.1b', 'q3.1',
        'task3.2a', 'task3.2b', 'q3.2'
        ])
    mgr.add_group("g4", [
        'q0',
        'task1b', 'task1a', 'q1',
        'task2.1d', 'task2.1b', 'task2.1c', 'task2.1a', 'q2.1',
        'task2.2d', 'task2.2c', 'task2.2a', 'q2.2',
        'task3.1b', 'task3.1a', 'q3.1',
        'task3.2b', 'task3.2a', 'q3.2'
        ])
